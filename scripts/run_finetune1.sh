...
#SBATCH --job-name=7_3_inject_effu_congestion
...
accelerate launch\
    ...
    --output_result_dir /scratch/c.c21051562/workspace/arrg_img2text/outputs_7_3_mix/results \
    --output_model_dir /scratch/c.c21051562/workspace/arrg_img2text/outputs_7_3_mix/models \
    --output_checkpoint_dir /scratch/c.c21051562/workspace/arrg_img2text/outputs_7_3_mix/checkpoints \
    ...
    --target_observation "['effusion', 'congestion']" \
    --num_epochs 1 \
...
# sbatch /scratch/c.c21051562/workspace/arrg_img2text/scripts/run_finetune1.sh
# scontrol show job JOBID
# scontrol show job JOBID | grep NodeList
# scancel JOBID

# tensorboard --logdir=/scratch/c.c21051562/workspace/arrg_img2text/outputs_7_3_mix/logs --port=6006
...
# mlflow server --host 127.0.0.1 --port 6006 --backend-store-uri file:/scratch/c.c21051562/workspace/arrg_img2text/outputs_7_3_mix/mlruns
